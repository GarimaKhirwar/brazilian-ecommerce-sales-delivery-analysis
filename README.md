...
The goal of this project is to analyze the business and operational performance of a Brazilian e-commerce platform using real transactional data.
The analysis focuses on answering key business questions around revenue generation, delivery efficiency, customer loyalty, and payment behavior, with the objective of identifying growth drivers, operational bottlenecks, and retention risks.
